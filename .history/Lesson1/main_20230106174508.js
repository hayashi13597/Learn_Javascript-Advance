...
//default values
const [i = 1, j = 1, k = 1] = [1, 2]; //k have default value is 1
const [q, w, e] = [1, 2]; //k values is undefined
console.log(i, j, k); //K value is 1
console.log(q, w, e); //E value is undefined
